window.POIGAME_RESEARCHED_GUIDES = Object.freeze({
  "ATLAS: EARTH": {
  ...
  "ファミリーファームの冒険": {
    ...
    description: "Lv26・30の実際の到達ペースと、掲示板注文・探索ポイント・ヤギミルク・エネルギーの回し方をまとめています。",
    links: [
  ...
  "マジックジグソーパズル": {
    ...
    description: "3,500〜15,000コイン系案件の実際の到達ペースと、広告・35〜70ピース・ミッション・日割りの進め方をまとめています。",
    links: [
