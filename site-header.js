(() => {
    ...
    style.textContent = `
      ...
      @media (max-width: 820px) {
        ...
        .poigame-mobile-nav__panel {
          ...
          box-shadow: 0 20px 60px rgba(35,15,86,.36);
        }
  ...
  const mobileNav = root.querySelector("#poigame-mobile-nav");
  const scrim = root.querySelector("[data-menu-close]");
